...
- "email_body": the full email body text in Spanish, professional and concise, ready to send. Plain text only — no asterisks, no bold, no markdown of any kind. Use numbered or plain dash lists if needed. Do not include a salutation or signature — the teacher will add those manually. Do NOT mention attachments — there are none. Only include information explicitly stated in the transcription; do not invent details, dates, or next steps that were not mentioned.
